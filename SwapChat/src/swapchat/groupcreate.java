...
public class groupcreate extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rs2 =stmt.executeQuery("select group_name from group_database where group_name='"+jTextField1.getText()+"'");
                    if (rs2.next()) {
                        JOptionPane.showMessageDialog(null,"This groupname is already taken");
                    } else {
                        List<String> a=jList1.getSelectedValuesList();
                        for(String s : a){
                            ResultSet rs=stmt.executeQuery("insert into group_database(group_name,group_member) values('"+jTextField1.getText()+"','"+ s +"')");
                        }
