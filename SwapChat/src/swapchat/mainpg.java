...
public class mainpg extends javax.swing.JFrame {
    ...
    public class Server implements Runnable{
        ...
        public synchronized boolean sendPrivateMsg(String senderName, String recipientName, String msg) {
            ...
            recipient.out.println(senderName + "\n" + msg);
            return true;
        }
        
        //in testing phase
        public synchronized boolean groupsend(String senderName, String groupName, String msg){
            try{
                ...
                ResultSet rs=stmt.executeQuery("select group_member from group_database where group_name='"+groupName+"'");
                while(rs.next()){
                    String recipientName = rs.getString("group_member");
                    if (senderName.equals(recipientName)) {
                        //return false;
                    }else{
                        ClientThread recipient = getClientThread(recipientName);
                        ...
                        recipient.out.println(groupName+"\n" + senderName + "\n" + msg);
                    //return true;
                    }
                }
                con.close();
                ...
                System.out.println("Group system is not working");
            }
            return true;
        }
                        ...
                        while ((serializedFromClient = in.readLine()) != null) {
                            try {
                                ...
                                //The user is sending a message to all the clients
                                    ...
                                    if (!groupsend(info.name, info.group, info.msg)) {
                                        out.println("<Couldn't send your message to " + info.group + ">");
